...
public class CategoryController {
    ...
    @RequestMapping("/bookmark") //즐겨찾기 메뉴
    public String bookmark_list(HttpServletRequest request, CategoryVO recipe, Model listM, Authentication authentication){
        ...
        int totalCount=this.categoryService.getbookCount(recipe);//총레코드 개수,검색후 레코드 개수,
