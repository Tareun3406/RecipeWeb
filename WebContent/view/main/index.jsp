            ...
            <ul class="rank-image-container">
                <li >
                    <label class="container-item">
                        <input type="radio" value="0" style="display: none;" onclick="rankOnClick(this)">
                ...
                <li >
                    <label class="container-item">
                        <input type="radio" value="1" style="display: none;" onclick="rankOnClick(this)">
                        <img class="menu-image" alt=""
                             src="../../images/recipeThum/food01.jpg">
                        <div class="recipe-info">
                            <ul>
                ...
                <li >
                    <label class="container-item">
                        <input type="radio" value="2" style="display: none;" onclick="rankOnClick(this)">
                        <img class="menu-image" alt=""
                             src="../../images/recipeThum/food01.jpg">
                        <div class="recipe-info">
                            <ul>
                ...
                <li >
                    <label class="container-item">
                        <input type="radio" value="3" style="display: none;" onclick="rankOnClick(this)">
                        <img class="menu-image" alt=""
                             src="../../images/recipeThum/food01.jpg">
                        <div class="recipe-info">
                            <ul>
                ...
                <li >
                    <label class="container-item">
                        <input type="radio" value="4" style="display: none;" onclick="rankOnClick(this)">
                        <img class="menu-image" alt=""
                             src="../../images/recipeThum/food01.jpg">
                        <div class="recipe-info">
                            <ul>
                ...
                <li >
                    <label class="container-item">
                        <input type="radio" value="5" style="display: none;" onclick="rankOnClick(this)">
                        <img class="menu-image" alt=""
                             src="../../images/recipeThum/food01.jpg">
                        <div class="recipe-info">
                            <ul>
                ...
                <li >
                    <label class="container-item">
                        <input type="radio" value="6" style="display: none;" onclick="rankOnClick(this)">
                        <img class="menu-image" alt=""
                             src="../../images/recipeThum/food01.jpg">
                        <div class="recipe-info">
                            <ul>
                ...
                <li >
                    <label class="container-item">
                        <input type="radio" value="7" style="display: none;" onclick="rankOnClick(this)">
                        <img class="menu-image" alt=""
                             src="../../images/recipeThum/food01.jpg">
                        <div class="recipe-info">
                            <ul>
