...
<div id="modDiv" style="display:none;">
    ...
    <div class="modal-title">dfdfdf ${replyList.reply_no}</div>  <%--댓글번호 --%>
    <div>
...
<script>
    ...
    function getAllList(){
        $.getJSON("/all/"+$comu_no, function(data){//jQuery 비동기식 $.getJSON()함수는 get방식으로 접근하는
            ...
            $(data).each(function(){//each()함수에의해서 li태그 단위로 댓글 개수만큼반복
                $str += "<li data-replyno='"+this.reply_no+"' class='replyLi'>"
    ...
    $('#replies').on('click',".replyLi button",function(){
        ...
        $reply_no = reply.attr("data-replyno");//댓글번호
    ...
    $('#replyModBtn').on('click',function(){
        ...
        $content=$('#recontent').val();//수정할 댓글 내용
